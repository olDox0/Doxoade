# doxoade/doxoade/tools/vulcan/cpu_flags.py
import platform
...
def simd_report():
    flags = cpu_flags()
    report = {'sse4_2': 'sse4_2' in flags, 'avx': 'avx' in flags, 'avx2': 'avx2' in flags, 'avx512': any((f.startswith('avx512') for f in flags)), 'level': simd_level(flags)}
    return report
