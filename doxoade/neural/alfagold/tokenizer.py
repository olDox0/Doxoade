...
class AlfagoldTokenizer:
    ...
    def train(self, text, vocab_size=1000):
        ...
        num_merges = max(0, vocab_size - 260)
        ...
        # [CRÍTICO] Garante que tokens especiais existam
    ...
    def encode(self, text):
        ...
        # [FIX] Define um ID de fallback seguro (0 se UNK não existir)
        ...
        for token in tokens_raw:
            ...
            for t in bpe_tokens:
                # [FIX] Usa get com default para garantir que nunca retorne None
