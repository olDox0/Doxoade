# doxoade/doxoade/commands/encoding.py
import os
import sys
import tempfile
...
def encoding(ctx, targets):
    ...
    encoding_aliases = {'utf8': 'utf-8', 'unicode': 'utf-8', 'utf16': 'utf-16', 'utf32': 'utf-32', 'latin1': 'latin-1', 'iso-8859-1': 'latin-1'}
        ...
        for target in input_targets:
            ...
            if not found_files and '*' not in target:
                if Path(target).is_file():
                    files_to_process.add(Path(target))
