    ...
    for f in all_files:
        try:
            ...
            if size_kb > 20:
                ...
                # Fallback: Verificação de linhas se o KB estiver no limite
...
def calculate_density_penalty(metrics: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    # Pesos atualizados: SYNTAX é agora uma ameaça de Nível 1
    weights = {
...
def _get_risk_styling(score: float):
    ...
    if score >= 60: return "WARNED", Fore.YELLOW, "🟡"
    if score >= 40: return "DANGER", Fore.RED, "🟠"
