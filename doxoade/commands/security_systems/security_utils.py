# doxoade/doxoade/commands/security_systems/security_utils.py
import os
import sys
import shutil
...
def get_tool_path(tool_name: str) -> str:
    ...
    if path_exe:
        return path_exe
    search_dirs = [os.path.join(sys.prefix, 'Scripts' if os.name == 'nt' else 'bin'), os.path.join(os.getcwd(), 'venv', 'Scripts' if os.name == 'nt' else 'bin')]
