# doxoade/doxoade/commands/impact_systems/impact_utils.py
import os
import json
...
def get_coupling_status(fan_out: int, fan_in: int):
    ...
    if total == 0:
        return (0.0, (Fore.GREEN, 'Independente'))
    instability = fan_out / total
    if instability > 0.7:
        return (instability, (Fore.RED, 'Frágil/Dependente'))
    if instability < 0.3:
        return (instability, (Fore.CYAN, 'Sólido/Central'))
