...
#            'backup': 'doxoade.commands.backup_systems:backup',
            'backup': 'doxoade.commands.backup_systems.backup_cmd:backup',
            'blacklist': 'doxoade.commands.hermes_blacklist_cmd:blacklist_group',
            'branch': 'doxoade.commands.git_systems.git_branch:branch',
            ...
            'image': 'doxoade.commands.image_systems.cmd_image:image_group',
            ...
            'merge': 'doxoade.commands.git_systems.git_merge:merge',
            ...
            'regret': 'doxoade.commands.regret_systems.cmd_regret:regret_group',
            'regression-test': 'doxoade.commands.regression_test:regression_test',
            'release': 'doxoade.commands.git_systems.git_workflow:release',
            'rescue': 'doxoade.commands.rescue_cmd:rescue',
#            'rewind': 'doxoade.commands.backup_systems:rewind',
            ...
            'timeline': 'doxoade.commands.timeline_systems.timeline_cli:timeline',
            'typhon': 'doxoade.commands.typhon_systems.typhon_cmd:typhon',
#            'typhon': 'doxoade.commands.typhon_systems.typhon_cmd:cli',
